...
func OpReturnTxBuilder() *wire.MsgTx {
	...
	// Put a message here with your name and AIS ID number so we can find your
	// submission on the blockchain.
	opReturnData := []byte("6892 Put message here") //52559 KristianK
	...
	// next, build the pubkey hash output. This is the same as before in the EZ function.
	// put the address you're sending to here. It can be the same as the address you're
	// spending from!
	sendToAddressString := ""
