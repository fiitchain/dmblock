...
The OP_RETURNs are due by Wed 22 Feb 23:59 (CET) or block #2578977.  Given the normal block arrival time, that should be at some point around the midnight.  (If blocks come out super quickly, we'll extend the block deadline as this class is still based on unix time rather than block height.)
...
<mark>You will get 4 points if you achieve to do everything AS in this tutorial.
